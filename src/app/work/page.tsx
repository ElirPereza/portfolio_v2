...
const projects: Project[] = [
  
  {
    num: "01",
    category: "Frontend",
    title: "Landing Treck Domane SL7",
    description: "I developed a landing page for this product.",
    stack: [
      { name: "Typescript" }, 
      { name: "React" }, 
      { name: "Next JS" },
    ...
    image: "/domane.png",
    live: "https://tourmaline-semolina-92cb68.netlify.app/",
    github: "",
  },
  {
    num: "02",
    category: "Frontend",
    title: "Blog",
    description: "Blog on administration and types of companies built with Next.js, Tailwind, Node, and TypeScript, offering an optimized experience for reading articles on business management.",
    stack: [
      { name: "Typescript" }, 
      { name: "React" }, 
      { name: "Next JS" },
    ...
    image: "/blog.png",
    live: "https://blog-administration-sharit.vercel.app/",
    github: "https://github.com/ElirPereza/blog-web.git",
  },
  {
    num: "03",
    category: "Frontend",
